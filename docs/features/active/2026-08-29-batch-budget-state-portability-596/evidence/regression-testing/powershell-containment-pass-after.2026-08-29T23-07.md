...
Output Summary: Pass-after run of the scoped PowerShell hook suite. Form A exited 0 with the passed
...
129). Form D shows both B-3 catch-body lines, 154 and 155, now covered. No BLOCKED branch taken.
