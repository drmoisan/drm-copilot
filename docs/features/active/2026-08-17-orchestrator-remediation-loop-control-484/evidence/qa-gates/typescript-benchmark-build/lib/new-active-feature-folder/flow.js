...
function createActiveFolder(options) {
    ...
    const retainsPotentialSource = potentialFile !== null &&
...
function isPromotedPotentialSource(potentialPath, workspacePath) {
    return isRelativeTo(potentialPath, (0, models_1.joinPosix)(workspacePath, "docs/features/potential/promoted"));
}
/**
