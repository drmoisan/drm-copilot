...
> - MCP server `drm-copilot` tool `resolve_policy_audit_template_asset` with the selector matching the artifact you need (`template`, `code-review-template`, `feature-audit-template`, or `agents`)  
