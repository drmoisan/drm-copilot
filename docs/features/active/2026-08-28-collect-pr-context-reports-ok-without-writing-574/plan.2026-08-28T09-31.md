...
- [ ] [P4-T1] Extract the two document-assembly blocks out of the collector so the module returns to the 500-line limit.
...
- [ ] [P4-T2] Mirror the head-SHA extension in the Python generation-timestamp helper.
...
- [ ] [P4-T3] Render one shared generated-context section first in both Python documents.
...
- [ ] [P4-T4] Add the Python freshness-header tests.
...
- [ ] [P4-T5] Add the narrow cross-runtime literal parity test.
...
- [ ] [P4-T6] Drive the Python pr-context suite to a clean run after the header change.
...
- [ ] [P7-T1] Produce the authoritative list of files this change writes.
...
- [ ] [P7-T2] Prove every non-Markdown file this change writes is at or under 500 lines.
...
- [ ] [P7-T3] Prove the two scope exclusions held.
