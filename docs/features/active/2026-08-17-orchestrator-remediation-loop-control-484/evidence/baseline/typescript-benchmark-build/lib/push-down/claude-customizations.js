...
function pushDownCustomizations(options) {
    const { repoRoot, destinationRoot, fs, sourceRoot, artifactRoot, packs, csharpVariant, memoryMode, bundleRoot, clock, } = options;
    ...
    const excludingFs = new claude_filesystem_adapter_1.ExcludingFileSystem(mergingFs, repoRoot, exports.EXCLUDED_RELATIVE_PATHS, {
