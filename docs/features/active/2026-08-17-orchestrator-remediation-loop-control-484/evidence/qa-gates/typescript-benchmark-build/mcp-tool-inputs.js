...
const VALID_ARTIFACT_TYPES = new Set(mcp_validator_catalog_1.VALIDATOR_ARTIFACT_TYPES);
const VALIDATE_ORCHESTRATION_ARTIFACT_INPUT_KEYS = new Set([
    "workspace_root",
    "artifact_type",
    "artifact_path",
    ...mcp_validator_catalog_1.VALIDATOR_VALIDATION_FLAGS,
]);
function resolveValidateOrchestrationArtifactsToolInput(rawInput, fallbackWorkspaceRoot) {
    ...
    return {
        ...
        ...(0, mcp_validator_catalog_1.selectValidatorFlags)(args),
    };
}
