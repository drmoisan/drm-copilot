# 2026-01-28-import-pre-built-functionality - Initiative Overview

- Issue: #8
- Owner: drmoisan
- Last Updated: 2026-02-04T12-23
...
- <Workstream A> (Issue #8) - `../<child-folder>/`
- <Workstream B> (Issue #8) - `../<child-folder>/`
- <Workstream C> (Issue #8) - `../<child-folder>/`
