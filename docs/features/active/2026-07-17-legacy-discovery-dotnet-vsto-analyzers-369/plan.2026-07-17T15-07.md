...
- [ ] [P0-T1] Read the repository policy files in the required order and record the read evidence artifact
...
- [ ] [P0-T2] Capture the baseline Black formatting state
...
- [ ] [P0-T3] Capture the baseline Ruff lint state
...
- [ ] [P0-T4] Capture the baseline Pyright type-check state
...
- [ ] [P0-T5] Capture the baseline pytest and coverage state
...
- [ ] [P0-T6] Verify the upstream #363/#360/#359 modules are present and record the sequencing-assumption evidence artifact
...
- [ ] [P1-T1] Create `scripts/dev_tools/discovery/analyzer/source_text.py` with the line-number-preserving C# comment/string stripper
  ...
  - Maps to: S-AC7, U-AC8.
- [ ] [P1-T2] Add the id slugifier, hash-suffix id builder, and line utilities to `scripts/dev_tools/discovery/analyzer/source_text.py`
...
- [ ] [P1-T3] Add the shared `TextParseResult` frozen dataclass to `scripts/dev_tools/discovery/analyzer/source_text.py`
  ...
  - Maps to: S-AC8.
- [ ] [P1-T4] Create `tests/scripts/dev_tools/discovery/analyzer/test_source_text.py` with parametrized stripper tests
...
- [ ] [P1-T5] Add slug/id and `TextParseResult` tests to `tests/scripts/dev_tools/discovery/analyzer/test_source_text.py`
...
- [ ] [P2-T1] Create the raw fixture `tests/fixtures/discovery_dotnet_vsto/csharp_declarations.cs.txt`
...
- [ ] [P2-T2] Create the raw fixture `tests/fixtures/discovery_dotnet_vsto/csharp_events.cs.txt`
...
- [ ] [P2-T3] Create `scripts/dev_tools/discovery/analyzer/dotnet_inventory.py` with the `DotnetInventoryAnalyzer` skeleton and `parse` stage
...
- [ ] [P2-T4] Implement the `classify` namespace and type detection catalog in `scripts/dev_tools/discovery/analyzer/dotnet_inventory.py`
...
- [ ] [P2-T5] Implement the `classify` event, delegate, and subscription detection catalog in `scripts/dev_tools/discovery/analyzer/dotnet_inventory.py`
...
- [ ] [P2-T6] Implement the `map` and `emit` stages in `scripts/dev_tools/discovery/analyzer/dotnet_inventory.py`
...
- [ ] [P2-T7] Create `tests/scripts/dev_tools/discovery/analyzer/test_dotnet_inventory.py` with the parametrized namespace/type detection matrix
  ...
  - Maps to: S-AC1, S-AC13, U-AC8.
- [ ] [P2-T8] Add the parametrized event/delegate/subscription detection matrix to `tests/scripts/dev_tools/discovery/analyzer/test_dotnet_inventory.py`
...
- [ ] [P2-T9] Add narrowing-failure, unreachable-root, and include/exclude routing tests to `tests/scripts/dev_tools/discovery/analyzer/test_dotnet_inventory.py`
...
- [ ] [P2-T10] Add the end-to-end emission and determinism test for the .NET analyzer to `tests/scripts/dev_tools/discovery/analyzer/test_dotnet_inventory.py`
...
- [ ] [P3-T1] Create the raw fixture `tests/fixtures/discovery_dotnet_vsto/ribbon_customui.xml.txt`
...
- [ ] [P3-T2] Create the raw fixture `tests/fixtures/discovery_dotnet_vsto/vsto_ribbon.cs.txt`
  ...
  - Maps to: S-AC3, S-AC13, U-AC8.
- [ ] [P3-T3] Create the raw fixture `tests/fixtures/discovery_dotnet_vsto/com_interop.cs.txt`
...
- [ ] [P3-T4] Create the raw fixture `tests/fixtures/discovery_dotnet_vsto/project_com_reference.xmlproj.txt`
  ...
  - Maps to: S-AC4, S-AC13, U-AC8.
- [ ] [P3-T5] Create `scripts/dev_tools/discovery/analyzer/vsto_office.py` with the `VstoOfficeAnalyzer` skeleton, `parse` stage, and file routing
...
- [ ] [P3-T6] Implement the Ribbon-XML detection catalog in `scripts/dev_tools/discovery/analyzer/vsto_office.py`
  ...
  - Maps to: S-AC3, U-AC2.
- [ ] [P3-T7] Implement the COM-interop detection catalog in `scripts/dev_tools/discovery/analyzer/vsto_office.py`
...
- [ ] [P3-T8] Implement the `map` and `emit` stages in `scripts/dev_tools/discovery/analyzer/vsto_office.py`
...
- [ ] [P3-T9] Create `tests/scripts/dev_tools/discovery/analyzer/test_vsto_office.py` with the parametrized Ribbon detection matrix
...
- [ ] [P3-T10] Add the parametrized COM-interop detection matrix to `tests/scripts/dev_tools/discovery/analyzer/test_vsto_office.py`
  ...
  - Acceptance: tests exist and pass; file remains under 500 lines.
  - Maps to: S-AC4, S-AC13, U-AC8.
- [ ] [P3-T11] Add routing, error-path, and end-to-end emission/determinism tests for the VSTO analyzer to `tests/scripts/dev_tools/discovery/analyzer/test_vsto_office.py`
...
- [ ] [P4-T1] Create `scripts/dev_tools/discovery/analyzer/stack_cli.py` with the shared `_run` helper and both entry functions
...
- [ ] [P4-T2] Add the two console-script lines to `pyproject.toml`
...
- [ ] [P4-T3] Create `tests/scripts/dev_tools/discovery/analyzer/test_stack_cli.py` with success-path CLI tests for both entry points
...
- [ ] [P4-T4] Add error-path and usage-error CLI tests to `tests/scripts/dev_tools/discovery/analyzer/test_stack_cli.py`
...
- [ ] [P5-T1] Create the feature-scoped domain-neutrality contract test `tests/scripts/dev_tools/discovery/analyzer/test_stack_neutrality.py`
...
- [ ] [P5-T2] Verify the 500-line limit for all new production and test modules and record the evidence artifact
  ...
  - Maps to: S-AC14.
- [ ] [P5-T3] Verify no new runtime dependency and no coverage exclusion were added and record the evidence artifact
...
- [ ] [P5-T4] Record the acceptance-criteria-to-test traceability artifact
...
- [ ] [P6-T1] Run the final Black formatting gate and record the evidence artifact
...
- [ ] [P6-T2] Run the final Ruff lint gate and record the evidence artifact
  - Command: `poetry run ruff check .`
...
- [ ] [P6-T3] Run the final Pyright type-check gate and record the evidence artifact
  - Command: `poetry run pyright`
...
- [ ] [P6-T4] Run the final pytest coverage gate and record the evidence artifact
  - Command: `poetry run pytest --cov --cov-branch --cov-report=term-missing`
...
- [ ] [P6-T5] Verify coverage thresholds and no-regression against the baseline and record the evidence artifact
