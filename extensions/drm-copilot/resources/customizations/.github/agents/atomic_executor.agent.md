...
- When completing a task or a plan, report the toolchain status explicitly: 
  ...
  - For powershell, this is `mcp__drmCopilotExtension__run_poshqc_format`, `mcp__drmCopilotExtension__run_poshqc_analyze`, and `mcp__drmCopilotExtension__run_poshqc_test`.
