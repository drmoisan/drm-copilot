# 2026-08-23-readme-misstates-npm-publish-credential (Plan)
...
- [ ] [P2-T1] [expect-fail] Add a small, deterministic regression test in the standard module file (use `tests/bugs/<YYYY>/#528-<desc>.py` only if no clear home exists)
