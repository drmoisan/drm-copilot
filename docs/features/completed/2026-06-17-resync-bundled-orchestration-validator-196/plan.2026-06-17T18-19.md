# resync-bundled-orchestration-validator (Plan)

- **Issue:** #196
- **Parent (optional):** none
- **Owner:** drmoisan
- **Last Updated:** 2026-06-17T18-19
- **Status:** Draft
- **Version:** 0.1
...
- [ ] [P2-T1] [expect-fail] Add a small, deterministic regression test in the standard module file (use `tests/bugs/<YYYY>/#196-<desc>.py` only if no clear home exists)
