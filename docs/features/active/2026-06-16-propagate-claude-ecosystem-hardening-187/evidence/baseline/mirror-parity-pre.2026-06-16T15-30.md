# Baseline Mirror Parity (pre-change) for F2 files
...
Output Summary: All four cmp invocations returned exit code 0. Both F2 canonical
files are byte-identical to both bundled mirrors before any edit, establishing
the pre-change parity baseline.
