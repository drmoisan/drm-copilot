# Final PowerShell Format, MCP Route-Compliance Call (Issue #697, Phase 14 iteration 1)

Timestamp: 2026-09-25T23-40
...
EXIT_CODE: 0
Output Summary: call disposition `{"ok":true,"tool":"run_poshqc_format",...,"summary":"Ran bundled PoshQC format against '<WORKSPACE_ROOT>' with 6 selected scan folder(s)."}`. The two hash tables are identical and the two porcelain listings are identical, so the call rewrote no file in the six scanned folders. No count is asserted from the MCP result (rule 12).
...
| `tests/scripts/codex-hooks/codex-planning-only-registry.Tests.ps1` | `88DC2F2BB89624EABCCBE4529B6A4E42D49C0DEE5FB548033D80CCCE9F137727` |
