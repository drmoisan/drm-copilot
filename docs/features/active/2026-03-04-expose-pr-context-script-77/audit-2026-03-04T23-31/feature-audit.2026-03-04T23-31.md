...
|---|---|---|---|---|
| Command Palette contributes `scaffoldExtension.collectPrContext` with clear title | PASS | `extensions/scaffold-extension/package.json` command contribution present | File inspection + Jest registration test | Title is `drm-copilot: Collect PR Context`. |
