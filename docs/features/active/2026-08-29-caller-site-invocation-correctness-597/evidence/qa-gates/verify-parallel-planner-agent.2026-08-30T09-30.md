...
Command: rg -F -c "git rev-parse --show-toplevel" .claude/agents/parallel-planner.md ; rg -F -c "-ErrorAction Stop" .claude/agents/parallel-planner.md ; rg -F -c "mandatory here." .claude/agents/parallel-planner.md
EXIT_CODE: 0
Output Summary: All three tokens match exactly once in .claude/agents/parallel-planner.md.
