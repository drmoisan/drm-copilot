...
### Inspect Container
```bash
docker inspect drm-copilot-dev
```

### Start Container Manually
```bash
docker start drm-copilot-dev
docker attach drm-copilot-dev
```
...
**Container Resources**
```bash
docker stats drm-copilot-dev
```

**Docker Logs**
```bash
docker logs drm-copilot-dev
```
...
**Remove Container**
```bash
docker rm -f drm-copilot-dev
```

**Remove Image**
```bash
docker images | grep drm-copilot
docker rmi <image-id>
```
