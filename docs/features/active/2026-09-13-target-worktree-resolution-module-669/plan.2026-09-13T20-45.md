...
- [ ] [P0-T1] Read the policy files in the required order and write `evidence/baseline/phase0-instructions-read.md`
...
- [ ] [P0-T2] Record the merge base and the pre-change worktree state
...
- [ ] [P0-T3] Record the current PowerShell batch-budget state
...
- [ ] [P0-T4] Capture the baseline PowerShell format stage and the tree it produces
...
- [ ] [P0-T5] Capture the baseline PowerShell analyze stage and its baseline finding set
...
- [ ] [P0-T6] Capture the baseline MCP test stage with repository-wide numeric coverage
...
- [ ] [P0-T7] Capture the baseline self-hosted PoshQC test invocation with numeric coverage
...
- [ ] [P0-T8] Record the observed element structure of the baseline coverage XML
...
- [ ] [P0-T9] Consolidate the recorded PoshQC baseline stage records
...
- [ ] [P0-T10] Capture the baseline result of the PoshQC bundled-parity Python test
...
- [ ] [P0-T11] Record the baseline acceptance-criteria checkbox counts in both AC source files
