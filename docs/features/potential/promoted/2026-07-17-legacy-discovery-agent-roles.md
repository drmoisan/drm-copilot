# legacy-discovery-agent-roles (Issue #365)

- Date captured: 2026-07-17
- Author: Dan Moisan
- Status: Promoted -> docs/features/active/legacy-discovery-agent-roles/ (Issue #365)

- Issue: #365
- Issue URL: https://github.com/drmoisan/drm-copilot/issues/365
