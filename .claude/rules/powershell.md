...
4. **Testing — Pester (v5.x)**: Run tests via MCP. MCP command: `mcp_drmcopilotext_run_poshqc_test`. Use repo config at `scripts/powershell/PoshQC/settings/pester.runsettings.psd1`.
