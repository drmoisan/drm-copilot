"""Tests for the extension-bundled new_active_feature_folder.py wrapper template."""
...
def test_imports_bundled_module() -> None:
    ...
    try:
        ...
        sys.modules.pop("ext_nafwt_imports", None)
...
def test_ensure_path_adds_scripts_dir_to_sys_path() -> None:
    ...
    try:
        ...
        sys.path[:] = original_sys_path
        sys.modules.pop("ext_nafwt_ensure_adds", None)
...
def test_ensure_path_skips_duplicate_entry() -> None:
    ...
    try:
        ...
        sys.path[:] = original_sys_path
        sys.modules.pop("ext_nafwt_ensure_skip", None)
...
def test_main_invokes_bundled_entrypoint_and_returns_zero() -> None:
    ...
    The bundled ``dev_tools.new_active_feature_folder`` module is mocked to avoid
    ...
    try:
        ...
        sys.path[:] = original_sys_path
        sys.modules.pop("ext_nafwt_main_test", None)
