# blast-radius-bundled-config-stale-skeleton (Plan)

- **Issue:** #500
- **Parent (optional):** none
- **Owner:** drmoisan
- **Last Updated:** 2026-08-21T17-26
- **Status:** Draft
- **Version:** 0.1
...
- [ ] [P2-T1] [expect-fail] Add a small, deterministic regression test in the standard module file (use `tests/bugs/<YYYY>/#500-<desc>.py` only if no clear home exists)
