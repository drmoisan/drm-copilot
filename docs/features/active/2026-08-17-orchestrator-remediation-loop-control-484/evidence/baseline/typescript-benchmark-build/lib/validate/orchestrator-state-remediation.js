...
exports.PREFLIGHT_CLEARED_STATUS = exports.EXECUTION_STATUSES_REQUIRING_CLEAR_PREFLIGHT = exports.REMEDIATION_CYCLES_KEY = exports.REMEDIATION_LOOP_KEY = void 0;
 ...
 */
exports.EXECUTION_STATUSES_REQUIRING_CLEAR_PREFLIGHT = new Set(["in_progress", "complete", "failed"]);
/** The preflight final status that clears the execution gate. */
exports.PREFLIGHT_CLEARED_STATUS = "clear";
/**
...
function validateRemediationCycle(index, cycle) {
    ...
    if (typeof planPath !== "string" || planPath.trim() === "") {
        errors.push(`Checkpoint remediation cycle #${index} plan_path must be a ` +
            "non-empty string.");
    }
    ...
    if (typeof executionStatus === "string" &&
        exports.EXECUTION_STATUSES_REQUIRING_CLEAR_PREFLIGHT.has(executionStatus)) {
        ...
        const preflightStatus = isObject(preflight)
            ? preflight["final_status"]
            : undefined;
        if (preflightStatus !== exports.PREFLIGHT_CLEARED_STATUS) {
...
function validateRemediationLoop(remediationLoop) {
    ...
    const cycles = remediationLoop[exports.REMEDIATION_CYCLES_KEY];
