...
def build_rewrite_catalog() -> dict[str, RewriteTarget]:
    ...
    targets = (
        RewriteTarget(
            ...
            command_id="scaffoldExtension.collectPrContext",
        ...
        RewriteTarget(
            ...
            command_id="scaffoldExtension.newActiveFeatureFolderPlaceholder",
        ...
        RewriteTarget(
            ...
            command_id="scaffoldExtension.potentialToIssuePlaceholder",
        ...
        RewriteTarget(
            ...
            command_id="scaffoldExtension.newPotentialBugEntryPyPlaceholder",
        ...
        RewriteTarget(
            ...
            command_id="scaffoldExtension.newPotentialEntryPsPlaceholder",
