...
def build_rewrite_catalog() -> dict[str, RewriteTarget]:
    ...
    targets = (
        ...
        RewriteTarget(
            ...
            command_id="drmCopilotExtension.newActiveFeatureFolder",
        ...
        RewriteTarget(
            ...
            command_id="drmCopilotExtension.potentialToIssue",
        ...
        RewriteTarget(
            ...
            command_id="drmCopilotExtension.newPotentialBugEntry",
        ...
        RewriteTarget(
            ...
            command_id="drmCopilotExtension.newPotentialEntry",
