# 2026-03-09-pr-context-not-bundled-extension-side (Plan)
...
- [ ] [P2-T1] [expect-fail] Add a small, deterministic regression test in the standard module file (use `tests/bugs/<YYYY>/#82-<desc>.py` only if no clear home exists)
