...
EXIT_CODE: 0
Output Summary: Pytest collected 20 tests and reported `20 passed in 0.12s`. Coverage headline for `scripts/dev_tools/validate_orchestration_artifacts.py`: 87% total line coverage (`259` statements, `33` missed, `226` covered).
