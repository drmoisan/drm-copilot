...
exports.FEATURE_AUDIT_REQUIRED_HEADINGS = exports.CODE_REVIEW_REQUIRED_HEADINGS = void 0;
exports.validateCodeReviewText = validateCodeReviewText;
exports.validateFeatureAuditText = validateFeatureAuditText;
/** Required headings for an audit-grade code review. */
exports.CODE_REVIEW_REQUIRED_HEADINGS = [
    "## Executive Summary",
    "## Findings Table",
];
/** Required canonical sections for a feature-audit artifact. */
exports.FEATURE_AUDIT_REQUIRED_HEADINGS = [
    "## Scope and Baseline",
...
const CODE_REVIEW_FINDINGS_TABLE_HEADER = "| Severity | File | Location | Finding | Recommendation | " +
    "Rationale | Evidence |";
/**
 ...
 */
function validateCodeReviewText(text) {
    const errors = [];
    // Require each canonical heading; absence of any heading is reported once.
    for (const heading of exports.CODE_REVIEW_REQUIRED_HEADINGS) {
 ...
 */
function validateFeatureAuditText(text) {
    const errors = [];
    // Require each canonical feature-audit section; report each missing heading.
    for (const heading of exports.FEATURE_AUDIT_REQUIRED_HEADINGS) {
        if (!text.includes(heading)) {
