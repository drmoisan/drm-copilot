...
- [x] Full PowerShell toolchain passes in a single pass: `mcp__drm-copilot__run_poshqc_format`, `mcp__drm-copilot__run_poshqc_analyze`, and `mcp__drm-copilot__run_poshqc_test` with `scripts/powershell/PoshQC/settings/pester.runsettings.psd1`, with zero PSScriptAnalyzer findings.
