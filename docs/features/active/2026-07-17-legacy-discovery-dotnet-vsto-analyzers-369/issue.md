...
- Author: Dan Moisan
- Status: Promoted -> docs/features/active/legacy-discovery-dotnet-vsto-analyzers/ (Issue #369)
...
- [ ] Create `docs/features/active/legacy-discovery-dotnet-vsto-analyzers/` folder from the template
