 ...
 */
export function runGitForTextOutput(
 ...
 */
export function scoreBranchForPriority(branchName: string): number {
 ...
 */
export function sortRemoteBranchCandidates(
 ...
 */
export function discoverPrBaseBranches(
  output: vscode.OutputChannel,
  commandId: string,
 ...
 */
export async function pickPrBaseBranch(
  output: vscode.OutputChannel,
  commandId: string,
  candidates: ReadonlyArray<string>,
