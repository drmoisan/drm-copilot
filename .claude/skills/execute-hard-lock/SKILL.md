...
- Local task (development only): `poetry run python scripts/dev_tools/resolve_hard_lock_prompt.py --target ${file} --workspace ${workspaceFolder}` (same: stdout + clipboard).
