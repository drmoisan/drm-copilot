...
class TestPlanParserInit:
    ...
    def test_init_with_valid_file(self, mem_fs_path: Path) -> None:
        """PlanParser initializes successfully with valid file path."""
        plan_file = mem_fs_path / "plan.md"
        plan_file.write_text("# Plan\n", encoding="utf-8")

        parser = PlanParser(plan_file)
        assert parser.plan_path == plan_file

    def test_init_with_nonexistent_file_raises(self, mem_fs_path: Path) -> None:
        """PlanParser raises FileNotFoundError for nonexistent file."""
        nonexistent = mem_fs_path / "missing.md"
...
class TestPlanParserParse:
    ...
    def test_parse_empty_file_returns_empty_model(self, mem_fs_path: Path) -> None:
    ...
    def test_parse_single_unchecked_task(self, mem_fs_path: Path) -> None:
    ...
    def test_parse_single_checked_task(self, mem_fs_path: Path) -> None:
    ...
    def test_parse_multiple_tasks_multiple_phases(self, mem_fs_path: Path) -> None:
...
"""
    ...
    def test_parse_ignores_non_task_lines(self, mem_fs_path: Path) -> None:
...
class TestPlanParserNextUncheckedTask:
    ...
    def test_next_unchecked_task_returns_first_unchecked(
        self, mem_fs_path: Path
    ) -> None:
...
class TestPlanParserFindTaskById:
    ...
    def test_find_task_by_id_returns_matching_task(self, mem_fs_path: Path) -> None:
...
"""
    ...
    def test_find_task_by_id_raises_for_missing_id(self, mem_fs_path: Path) -> None:
...
class TestPlanParserPhaseComplete:
    ...
    def test_phase_complete_returns_true_when_all_checked(
        self, mem_fs_path: Path
    ) -> None:
...
class TestPlanParserFlipCheckbox:
    ...
    def test_flip_checkbox_checks_unchecked_task(self, mem_fs_path: Path) -> None:
...
"""
    ...
    def test_flip_checkbox_is_idempotent_for_checked_task(
        self, mem_fs_path: Path
    ) -> None:
...
"""
    ...
    def test_flip_checkbox_preserves_other_lines(self, mem_fs_path: Path) -> None:
...
"""
    ...
    def test_preflight_validate_raises_when_both_missing(
        self, mem_fs_path: Path
    ) -> None:
...
class TestPlanParserEdgeCases:
    ...
    def test_parse_handles_mixed_checkbox_formats(self, mem_fs_path: Path) -> None:
...
"""
    ...
    def test_parse_handles_whitespace_variations(self, mem_fs_path: Path) -> None:
...
"""
    ...
    def test_flip_checkbox_is_idempotent(self, mem_fs_path: Path) -> None:
