# expose-commit-script (Potential)
...
- [ ] Collector process is launched with destination workspace root as working directory, and Git introspection targets that repository.
