...
exports.REPO_MEMORY_SCOPE = exports.GENERAL_MEMORY_SCOPE = exports.AGENT_MEMORY_RELATIVE_ROOT = void 0;
exports.readMemoryScope = readMemoryScope;
exports.isUnderAgentMemory = isUnderAgentMemory;
exports.isGeneralMemoryFile = isGeneralMemoryFile;
/** Relative root beneath which agent-memory files live. */
exports.AGENT_MEMORY_RELATIVE_ROOT = ".claude/agent-memory";
/** Scope value that permits distribution of an agent-memory file. */
exports.GENERAL_MEMORY_SCOPE = "general";
/** Fail-safe default scope that excludes an agent-memory file from push-down. */
exports.REPO_MEMORY_SCOPE = "repo";
/**
 ...
 */
const METADATA_BLOCK_PATTERN = /^metadata:[ \t]*\r?\n((?:[ \t]+.*(?:\r?\n|$)|\r?\n)*)/m;
/**
 ...
 */
function readMemoryScope(content) {
    ...
    if (frontmatterMatch === null) {
        return exports.REPO_MEMORY_SCOPE;
    }
    ...
    return scopeValue === exports.GENERAL_MEMORY_SCOPE
        ? exports.GENERAL_MEMORY_SCOPE
        : exports.REPO_MEMORY_SCOPE;
}
/**
...
function isUnderAgentMemory(relativePosixPath) {
    ...
    return (normalized === exports.AGENT_MEMORY_RELATIVE_ROOT ||
        normalized.startsWith(`${exports.AGENT_MEMORY_RELATIVE_ROOT}/`));
}
/**
...
function isGeneralMemoryFile(relativePosixPath, content) {
    ...
    return readMemoryScope(content) === exports.GENERAL_MEMORY_SCOPE;
}
