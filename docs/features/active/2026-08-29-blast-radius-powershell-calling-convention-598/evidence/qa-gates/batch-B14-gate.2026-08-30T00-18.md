# Batch B14 gate — `blast-radius/BlastRadiusConfig.psm1`
...
Batch content: `.claude/lib/blast-radius/BlastRadiusConfig.psm1` and `extensions/drm-copilot/resources/claude-customizations/.claude/lib/blast-radius/BlastRadiusConfig.psm1` (2 production files).
