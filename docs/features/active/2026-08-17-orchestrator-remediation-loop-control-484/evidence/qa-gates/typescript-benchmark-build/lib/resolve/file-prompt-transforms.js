...
exports.removeUserStoryClauseWhenMissing = removeUserStoryClauseWhenMissing;
exports.removeLinesReferencingVariable = removeLinesReferencingVariable;
exports.insertAfterHeading = insertAfterHeading;
exports.applyMinorAuditOverrides = applyMinorAuditOverrides;
 ...
 */
function removeUserStoryClauseWhenMissing(template) {
 ...
 */
function removeLinesReferencingVariable(template, variableName) {
 ...
 */
function insertAfterHeading(template, heading, block) {
    const lines = splitLinesKeepEnds(template);
 ...
 */
function applyMinorAuditOverrides(template) {
 ...
 */
function replaceAllVariables(template, variables) {
    ...
    if (extractTemplateVariables(resolved).size > 0) {
        throw new Error("Template resolution failed: unresolved placeholders remain");
    }
    return resolved;
}
