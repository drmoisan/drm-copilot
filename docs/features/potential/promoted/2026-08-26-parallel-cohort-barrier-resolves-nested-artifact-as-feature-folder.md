# parallel-cohort-barrier-resolves-nested-artifact-as-feature-folder (Issue #566)

- Date captured: 2026-08-26
- Author: Dan Moisan
- Status: Promoted -> docs/features/active/parallel-cohort-barrier-resolves-nested-artifact-as-feature-folder/ (Issue #566)

> Automation note: Keep the section headings below unchanged; the promotion tooling maps each of them into the GitHub bug issue template.

- Issue: #566
- Issue URL: https://github.com/drmoisan/drm-copilot/issues/566
...
Scope is the hook, its bundled mirror at `extensions/drm-copilot/resources/claude-customizations/.claude/hooks/enforce-parallel-cohort-barrier.ps1`, and its Pester test file. Editing the mirror is not optional.
